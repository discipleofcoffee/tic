...
def main():
    ...
    parser.add_argument('-s','--save',       help='Save intermediate steps', default = '.' )
    ...
    create_pial_mask(inArgs.subject_id, inArgs.subjects_dir, inArgs.out, output_directory,  reference=inArgs.reference, verbose=inArgs.verbose)
