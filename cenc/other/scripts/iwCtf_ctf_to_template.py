...
if __name__ == "__main__":
     ...
     parser.add_argument("--image",           help="ANTS Affine tranformation Template To Subject", default='TemplateToSubject1GenericAffine.mat')
     ...
     if inArgs.verbose:
          ...
          print "inArgs.out_points        = " +  str(inArgs.out_native)
          print "inArgs.out_template      = " +  str(inArgs.out_template)
     ...
     cmd = [ "antsApplyTransformsToPoints", "-d", "3", "-i", inArgs.in_ctf, "-o", inArgs.out_native, 
             "-t", "[", inArgs.wlps_to_wctf,",", "1", "]" ]
     ...
     cmd = [ "antsApplyTransformsToPoints", "-d", "3", "-i", inArgs.in_ctf, "-o", inArgs.out_template, 
             "-t", "[", inArgs.wlps_to_wctf,",", "1", "]", inArgs.ants_affine, inArgs.ants_warp ]
